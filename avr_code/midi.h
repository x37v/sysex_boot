...
//
//MIDI is an asynchronous serial interface. The baud rate is 31.25 Kbaud (+/-
//1%). There is 1 start bit, 8 data bits, and 1 stop bit (ie, 10 bits total),
...
//This ID is for educational or development use only, and should never appear
